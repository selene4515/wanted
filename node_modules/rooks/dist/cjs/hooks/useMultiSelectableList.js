...
function useMultiSelectableList(list = [], initialSelectIndices = [0], allowUnselected = false) {
    ...
    const toggleSelectionByIndex = react.useCallback((index) => {
        let newIndices;
    ...
    const toggleSelection = react.useCallback(({ index, value }) => {
        return () => {
    ...
    const matchSelection = react.useCallback(({ index, value }) => {
