...
var useFreshRef = require('./useFreshRef.js');
var useGetIsMounted = require('./useGetIsMounted.js');
...
function useAsyncEffect(effect, deps, cleanup) {
    ...
    const getIsMounted = useGetIsMounted.useGetIsMounted();
    const effectRef = useFreshRef.useFreshRef(effect);
